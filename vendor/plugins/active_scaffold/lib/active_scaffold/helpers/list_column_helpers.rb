...
module ActiveScaffold
  module Helpers
    ...
    module ListColumnHelpers
      ...
      # THEIRTODO: move empty_field_text and &nbsp; logic in here?
      # THEIRTODO: move active_scaffold_inplace_edit in here?
      # THEIRTODO: we need to distinguish between the automatic links *we* create and the ones that the dev specified. some logic may not apply if the dev specified the link.
